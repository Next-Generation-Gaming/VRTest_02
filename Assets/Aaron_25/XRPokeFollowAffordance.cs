...
{
    // EDITED BY AARON TO ALLOW BUTTON EVENTS , IF CLASHING WITH ANOTHER DO NOT DELETE THIS SCRIPT, DELETE THE OTHER/DEFAULT SCRIPT
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        void OnPokeStateDataUpdated(PokeStateData data)
        {
            ...
            if (applyFollow)
            {
                ...
                Debug.Log("Distance to Target: " + targetPosition.magnitude + ", Max Distance: " + m_MaxDistance);
